...
public class Auton5663_eocv extends LinearOpMode {
    ...
    public void moveToWhiteLineForZoneC(double segmentTimeLimit) {
        ...
        if (opModeIsActive()) {
            ...
            // Drive Targets
            double speed = .5;
            double FL_Distance = -23.5;
            double FR_distance = -23.5;
            double BL_distance = -23.5;
            double BR_distance = -23.5;
    ...
    public void driveToZoneC(double segmentTimeLimit) {
        ...
        if (opModeIsActive()) {
            ...
            // Drive Targets
            double speed = .5;
            double FL_Distance = -28.5;
            double FR_distance = -28.5;
            double BL_distance = -28.5;
            double BR_distance = -28.5;
