...
public class Robot {
    ...
    private final double TZAV_0_Reading = 115.1;   // tested reading for no rings - was 125
    private final double TZAV_1_Reading = 115;   // tested reading for one ring - was 110
